(function () {
    ...
    var indonesiaProvinceCityData = typeof window !== "undefined"
        && window.INDONESIA_PROVINCE_CITY_DATA
        && typeof window.INDONESIA_PROVINCE_CITY_DATA === "object"
        ? window.INDONESIA_PROVINCE_CITY_DATA
        : {
            "DKI JAKARTA": {
    ...
    var ADDRESS_REGION_DATA = {
        Indonesia: indonesiaProvinceCityData,
        Malaysia: {
            "Kuala Lumpur": {
                "Kuala Lumpur": ["Bukit Bintang", "Cheras", "Setapak"]
            },
            Selangor: {
                "Shah Alam": ["Seksyen 7", "Seksyen 13", "Seksyen 15"],
                "Petaling Jaya": ["Damansara", "Kelana Jaya", "Bandar Utama"],
                Klang: ["Klang Utara", "Klang Selatan", "Kapar"]
            },
            Johor: {
                "Johor Bahru": ["Tebrau", "Skudai", "Larkin"],
                "Iskandar Puteri": ["Nusajaya", "Gelang Patah", "Medini"],
                "Batu Pahat": ["Penggaram", "Ayer Hitam", "Parit Raja"]
            }
        },
        Singapore: {
            Singapore: {
                Central: ["Orchard", "Newton", "River Valley"],
        ...
        Thailand: {
            Bangkok: {
                Bangkok: ["Phra Nakhon", "Pathum Wan", "Sathon"]
            },
            ChiangMai: {
                ChiangMai: ["Mueang Chiang Mai", "Hang Dong", "Saraphi"]
            },
            Phuket: {
        ...
        Philippines: {
            NCR: {
                ...
                QuezonCity: ["Diliman", "Cubao", "Novaliches"],
                Makati: ["Bel-Air", "Poblacion", "San Lorenzo"]
            },
            Cebu: {
                CebuCity: ["Lahug", "Mabolo", "Talamban"],
                Mandaue: ["Centro", "Bakilid", "Subangdaku"]
            }
        },
        Vietnam: {
            Hanoi: {
                Hanoi: ["Ba Dinh", "Hoan Kiem", "Dong Da"]
            },
            "Ho Chi Minh City": {
                "Ho Chi Minh City": ["District 1", "District 3", "Thu Duc"]
            },
            DaNang: {
                DaNang: ["Hai Chau", "Thanh Khe", "Son Tra"]
            }
        },
        Japan: {
            Tokyo: {
        ...
        China: {
            ...
            Shanghai: {
                Shanghai: ["Pudong", "Huangpu", "Minhang"]
            },
            Guangdong: {
                Guangzhou: ["Tianhe", "Yuexiu", "Panyu"],
        ...
        India: {
            Maharashtra: {
                ...
                Pune: ["Shivajinagar", "Kothrud", "Hinjawadi"]
            },
            Delhi: {
        ...
        "United States": {
            California: {
                "Los Angeles": ["Hollywood", "Downtown", "Venice"],
                "San Francisco": ["Mission", "Sunset", "SOMA"]
            },
            "New York": {
            ...
            Texas: {
                ...
                Austin: ["Downtown", "Zilker", "Riverside"]
            }
        },
        Canada: {
            Ontario: {
            ...
            Quebec: {
                Montreal: ["Ville-Marie", "Plateau", "Rosemont"]
            },
            "British Columbia": {
                Vancouver: ["Downtown", "Kitsilano", "Richmond"]
            }
        },
        Australia: {
            NSW: {
                Sydney: ["CBD", "Parramatta", "Bondi"]
            },
            Victoria: {
        ...
        "United Kingdom": {
            ...
            Scotland: {
                ...
                Glasgow: ["City Centre", "West End", "Govan"]
            }
        },
        Germany: {
            Bavaria: {
                Munich: ["Altstadt", "Schwabing", "Bogenhausen"]
            },
            Berlin: {
                Berlin: ["Mitte", "Kreuzberg", "Charlottenburg"]
            },
            Hesse: {
                Frankfurt: ["Innenstadt", "Sachsenhausen", "Bockenheim"]
            }
        },
        France: {
            "Ile-de-France": {
                Paris: ["1st Arrondissement", "7th Arrondissement", "Montmartre"]
            },
            "Provence-Alpes-Cote dAzur": {
                Marseille: ["Le Panier", "Vieux-Port", "La Joliette"]
            },
            AuvergneRhoneAlpes: {
                Lyon: ["Presquile", "Vieux Lyon", "La Part-Dieu"]
            }
        },
        Netherlands: {
            "North Holland": {
            ...
            "South Holland": {
                ...
                "The Hague": ["Centrum", "Scheveningen", "Loosduinen"]
            }
        },
        "United Arab Emirates": {
            ...
            "Abu Dhabi": {
                "Abu Dhabi": ["Al Zahiyah", "Al Khalidiyah", "Al Reem Island"]
            }
        },
        "Saudi Arabia": {
            Riyadh: {
    ...
    function applyCropSelection() {
        ...
        exportCanvas.toBlob(function (blob) {
            ...
            if (isSystemLogoCrop) {
                ...
                if (navbarLogo) {
                    navbarLogo.src = pendingSystemLogoPreviewUrl;
                } else if (brandMark) {
                    brandMark.classList.add("has-logo");
                    brandMark.innerHTML = '<a href="/"><img class="brand-logo" src="' + pendingSystemLogoPreviewUrl + '" alt="Logo"></a>';
                }
    ...
    function syncAddressHiddenInput() {
        if (!memberAddressInput) {
            return;
        }

        var addressParts = [];
        var country = getAddressFormValue(memberAddressCountrySelect);
        var province = getAddressFormValue(memberAddressProvinceSelect);
        var city = getAddressFormValue(memberAddressCitySelect);
        var district = getAddressFormValue(memberAddressDistrictSelect);
        var detail = getAddressFormValue(memberAddressDetailInput);
        ...
        memberAddressInput.value = addressParts.join(", ");
    }

    function syncAddressRequirements() {
        var hasProvinceField = memberAddressProvinceField && !memberAddressProvinceField.classList.contains("hidden");
        var hasCityField = memberAddressCityField && !memberAddressCityField.classList.contains("hidden");
        var hasDistrictField = memberAddressDistrictField && !memberAddressDistrictField.classList.contains("hidden");

        if (memberAddressProvinceSelect) {
            memberAddressProvinceSelect.required = hasProvinceField;
            memberAddressProvinceSelect.disabled = !hasProvinceField;
        }

        if (memberAddressCitySelect) {
            memberAddressCitySelect.required = hasCityField;
            memberAddressCitySelect.disabled = !hasCityField;
        }

        if (memberAddressDistrictSelect) {
            memberAddressDistrictSelect.required = hasDistrictField;
            memberAddressDistrictSelect.disabled = !hasDistrictField;
        }
    }

    function updateAddressDistrictOptions(selectedCountry, selectedProvince, selectedCity, selectedDistrict) {
        ...
        fillAddressSelectOptions(
            memberAddressDistrictSelect,
            "Select district",
            districtOptions,
            selectedDistrict || ""
        );
        setAddressFieldVisibility(memberAddressDistrictField, shouldShowDistrict);
        syncAddressRequirements();
        syncAddressHiddenInput();
    }

    function updateAddressCityOptions(selectedCountry, selectedProvince, selectedCity, selectedDistrict, requestSerial) {
        var countryData = ADDRESS_REGION_DATA[selectedCountry] || null;
        var provinceData = countryData && countryData[selectedProvince] ? countryData[selectedProvince] : null;
        var currentSerial = requestSerial || addressCascadeRequestSerial;
        ...
        var renderCityOptions = function () {
            ...
            fillAddressSelectOptions(memberAddressCitySelect, "Select city", cityOptions, selectedCity || "");
            setAddressFieldVisibility(memberAddressCityField, shouldShowCity);

            if (!shouldShowCity) {
                fillAddressSelectOptions(memberAddressDistrictSelect, "Select district", [], "");
                setAddressFieldVisibility(memberAddressDistrictField, false);
                syncAddressRequirements();
                syncAddressHiddenInput();
                return;
            }
            ...
            updateAddressDistrictOptions(
                selectedCountry,
                selectedProvince,
                getAddressFormValue(memberAddressCitySelect),
                selectedDistrict || ""
            );
        };
        ...
        ensureAddressProvinceCityDataLoaded(selectedCountry, selectedProvince).then(function () {
            if (currentSerial !== addressCascadeRequestSerial) {
                return;
            }
            renderCityOptions();
        });
    ...
    function updateAddressProvinceOptions(selectedCountry, selectedProvince, selectedCity, selectedDistrict, requestSerial) {
        var countryData = ADDRESS_REGION_DATA[selectedCountry] || null;
        ...
        fillAddressSelectOptions(
            memberAddressProvinceSelect,
            "Select province",
            provinceOptions,
            selectedProvince || ""
        );
        setAddressFieldVisibility(memberAddressProvinceField, shouldShowProvince);

        if (!shouldShowProvince) {
            fillAddressSelectOptions(memberAddressCitySelect, "Select city", [], "");
            fillAddressSelectOptions(memberAddressDistrictSelect, "Select district", [], "");
            setAddressFieldVisibility(memberAddressCityField, false);
            setAddressFieldVisibility(memberAddressDistrictField, false);
            syncAddressRequirements();
            syncAddressHiddenInput();
            return;
        ...
        updateAddressCityOptions(
            selectedCountry,
            getAddressFormValue(memberAddressProvinceSelect),
            selectedCity || "",
            selectedDistrict || "",
            requestSerial || addressCascadeRequestSerial
        );
    }

    function initializeMemberAddressCascade() {
        if (!memberAddressCountrySelect || !memberAddressInput) {
            return;
        }
        ensureAddressCountryDataLoaded().finally(function () {
            var countries = sortAddressOptionLabels(Object.keys(ADDRESS_REGION_DATA));
            fillAddressSelectOptions(memberAddressCountrySelect, "Select country", countries, "");

            var oldCountry = getAddressFormValue(memberAddressCountryOldInput);
            var oldProvince = getAddressFormValue(memberAddressProvinceOldInput);
            var oldCity = getAddressFormValue(memberAddressCityOldInput);
            var oldDistrict = getAddressFormValue(memberAddressDistrictOldInput);
            var oldDetail = getAddressFormValue(memberAddressDetailOldInput);

            if (oldDetail !== "" && memberAddressDetailInput && getAddressFormValue(memberAddressDetailInput) === "") {
                memberAddressDetailInput.value = oldDetail;
            }

            if (oldCountry === "") {
                var oldAddress = getAddressFormValue(memberAddressInput);
                if (oldAddress !== "") {
                    var oldAddressParts = oldAddress.split(",");
                    if (oldAddressParts.length > 0) {
                        oldCountry = String(oldAddressParts[0] || "").trim();
                    }
                }
            }

            if (oldCountry !== "") {
                memberAddressCountrySelect.value = oldCountry;
            }

            addressCascadeRequestSerial += 1;
            updateAddressProvinceOptions(
                getAddressFormValue(memberAddressCountrySelect),
                oldProvince,
                oldCity,
                oldDistrict,
                addressCascadeRequestSerial
            );

            syncAddressHiddenInput();

            memberAddressCountrySelect.addEventListener("change", function () {
                memberAddressCountrySelect.setCustomValidity("");
                addressCascadeRequestSerial += 1;
                updateAddressProvinceOptions(
                    getAddressFormValue(memberAddressCountrySelect),
                    "",
            ...
            if (memberAddressProvinceSelect) {
                memberAddressProvinceSelect.addEventListener("change", function () {
                    addressCascadeRequestSerial += 1;
                    updateAddressCityOptions(
                        getAddressFormValue(memberAddressCountrySelect),
                        getAddressFormValue(memberAddressProvinceSelect),
            ...
            if (memberAddressCitySelect) {
                memberAddressCitySelect.addEventListener("change", function () {
                    updateAddressDistrictOptions(
                        getAddressFormValue(memberAddressCountrySelect),
                        getAddressFormValue(memberAddressProvinceSelect),
                        getAddressFormValue(memberAddressCitySelect),
            ...
            if (memberAddressDistrictSelect) {
                memberAddressDistrictSelect.addEventListener("change", function () {
                    syncAddressHiddenInput();
                });
            }

            if (memberAddressDetailInput) {
                memberAddressDetailInput.addEventListener("input", function () {
                    syncAddressHiddenInput();
                });
            }
            ...
            if (addMemberForm) {
                addMemberForm.addEventListener("submit", function (event) {
                    syncAddressHiddenInput();
                    if (getAddressFormValue(memberAddressCountrySelect) === "") {
                        memberAddressCountrySelect.setCustomValidity("Please select country first.");
                        memberAddressCountrySelect.reportValidity();
    ...
    function openEditUserModal(payload) {
        ...
        if (editLifeStatus) {
            editLifeStatus.value = payload.life_status || "";
        }
        ...
        var isFamilySource = source === "family member";
        if (editRoleField) {
            editRoleField.classList.toggle("hidden", isFamilySource);
        }
        if (editFamilyFields) {
        ...
        if (editRole) {
            if (isFamilySource) {
                editRole.removeAttribute("required");
            } else {
                editRole.setAttribute("required", "required");
            }
        }
    ...
    if (treeContainer) {
        ...
        function refreshTreeZoomSize(options) {
            ...
            if (
                ...
                treeContainer.scrollTop = Math.max(0, Math.round(treeVirtualPaddingY + ((scaledCanvasHeight - treeContainer.clientHeight) / 3)));
        ...
        function runInitialTreeCenteringLoop() {
            ...
            if (Date.now() > treeInitialCenteringDeadline) {
                treeInitialCenteringDeadline = 0;
                return;
            }
            ...
            window.requestAnimationFrame(function () {
                ...
                window.setTimeout(runInitialTreeCenteringLoop, 24);
            });
        }
    ...
    function syncMemberActionAccessBySelectedCard(card) {
        ...
        var showActionBlock = canDeletePartner || canDeleteChild || canUpdateLifeStatus || canEditProfile;
