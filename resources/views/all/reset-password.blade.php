<main class="login-shell auth-shell">
    <section class="login-panel">
        ...
        <p class="panel-subtitle">Link reset valid. Silakan buat password baru untuk akun Anda.</p>
        ...
        <form method="POST" action="/reset-password/<?php echo e($token); ?>">
            <?php echo csrf_field(); ?>
        ...
        <p class="panel-note">Kembali ke <a class="forgot" href="/login">Sign In</a></p>
    </section>
</main>
